...
!function (a, b) {
        ...
        var d = function (a) {
            ...
            this.data = [], this.parameters = function (b, c) {
                ...
                if (d = 11, i = [], h = Math.ceil(b / c), h > 1) {
                    ...
                    for (var j = g; e >= j;)j === g && 2 !== j || j === e && j !== h - 1 ? i.push({
                            type: "more",
                            active: !1
                        }) : i.push({type: "page", number: j, active: a !== j}), j++;
    ...
    var c = ["$scope", "ngTableParams", "$timeout", function (b, c, d) {
                ...
                return a.forEach(a.element(c.find("tr")), function (b) {
                    b = a.element(b), b.hasClass("ng-table-group") || g || (g = b)
                        ...
                        if (c.$loading = !1, c.$columns = d, c.$watch(g.ngTable, function (b) {
                            ...
                            var i = h.length > 0 ? h : a.element(document.createElement("thead")).attr("ng-include", "templates.header"), j = a.element(document.createElement("tr")).append(a.element(document.createElement("td")).attr({
                                "ng-table-pagination": "params",
                                "template-url": "templates.pagination",
                                colspan: d.length
                            })), k = a.element(document.createElement("tfoot")).append(j);
                            f.find("thead").remove(), f.addClass("ng-table").prepend(i).append(k), b(i)(c), b(k)(c)
                        }
                    }) : void 0
            }
        }
